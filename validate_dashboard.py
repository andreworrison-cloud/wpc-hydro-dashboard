...
required_basemap_fragments = [
    ...
    "referenceLayer: esriDarkLabels",
    "referenceLayer: esriLightLabels",
]
for fragment in required_basemap_fragments:
    if fragment not in app:
        errors.append(f"Missing expanded basemap integration fragment: {fragment}")
